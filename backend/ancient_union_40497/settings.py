"""
Django settings for ancient_union_40497 project.
...
ROOT_URLCONF = 'ancient_union_40497.urls'
...
WSGI_APPLICATION = 'ancient_union_40497.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "ancient_union_40497 API",
    "DESCRIPTION": "API documentation for ancient_union_40497 App",
    "VERSION": "v1",
}
